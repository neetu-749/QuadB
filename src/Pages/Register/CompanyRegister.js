...
export default function CompanyRegister() {
    ...
    const onSubmit = (formValues) => {
        ...
        if (formValues.username === "") {
            ...
            isLoading(false);
        }else if (formValues.sales === "") {  
            toast.error("Please enter sales");
            isLoading(false);
        }else if (formValues.profit === "") {  
            toast.error("Please enter profit");
            isLoading(false);
        }else if (formValues.evolution === "") {  
            toast.error("Please enter evolution");
            isLoading(false);
        }else if (formValues.year === "") {  
            toast.error("Please enter year");
            isLoading(false);
        }else if (formValues.equity === "") {  
            toast.error("Please enter equity");
            isLoading(false);
                       ...
                       setUrl(downloadURL);
                        ...
                        async ()=>{
                            ...
                            try{
                                    ...
                                    const res = await publicRequest.post("/auth/companyregister",{
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={errors.sales ? { border_color: "red" } : {}}
                                            type="number"
                                            name="sales"
                                            className="appearance-none rounded-none text-sm font-medium relative block w-full px-5 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md :outline-none :ring-indigo-500 :border-indigo-500 :z-10 mt-2"
                                            placeholder="Enter approx amount you want to get invest"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={errors.profit ? { border_color: "red" } : {}}
                                            type="number"
                                            name="profit"
                                            className="appearance-none rounded-none text-sm font-medium relative block w-full px-5 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md :outline-none :ring-indigo-500 :border-indigo-500 :z-10 mt-2"
                                            placeholder="Enter last profit of company"
                                        />
                                    </div>
                                    <div>
                                        <label htmlFor="evolution" className="font-medium">
                                        evolution<span style={{ color: "red" }}>*</span>
                                        </label>
                                        <input
                                            {...register("evolution", { required: true })}
                                            style={errors.evolution ? { border_color: "red" } : {}}
                                            type="number"
                                            name="evolution"
                                            className="appearance-none rounded-none text-sm font-medium relative block w-full px-5 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md :outline-none :ring-indigo-500 :border-indigo-500 :z-10 mt-2"
                                            placeholder="Enter last evolution you get"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            style={errors.year ? { border_color: "red" } : {}}
                                            type="number"
                                            name="year"
                                            className="appearance-none rounded-none text-sm font-medium relative block w-full px-5 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md :outline-none :ring-indigo-500 :border-indigo-500 :z-10 mt-2"
                                            placeholder="Enter the age of company in years"
                                        />
                                    </div>
                                    <div>
                                        <label htmlFor="equity" className="font-medium">
                                        equity<span style={{ color: "red" }}>*</span>
                                        </label>
                                        <input
                                            {...register("equity", { required: true })}
                                            style={errors.equity ? { border_color: "red" } : {}}
                                            type="number"
                                            name="equity"
                                            className="appearance-none rounded-none text-sm font-medium relative block w-full px-5 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md :outline-none :ring-indigo-500 :border-indigo-500 :z-10 mt-2"
                                            placeholder="Enter equity you want to disolve"
                                        />
                                    </div>
